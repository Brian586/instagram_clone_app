    ...
    return Container(
      ...
      child: FlatButton(
        ...
        child: Container(
          ...
          child: Text(
            title,
            style: TextStyle(color: following ? Colors.blue[800] : Colors.white70, fontWeight: FontWeight.bold),
          ),
          alignment: Alignment.center,
          decoration: BoxDecoration(
              color: following ? Colors.black : Colors.black,
            border: Border.all(color: following ? Colors.blue[800] : Colors.blue[800],),
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            Padding(
              ...
              child: Text("No Posts", style: TextStyle(color: Colors.white, fontSize: 40.0, fontWeight: FontWeight.bold),),
            ),
          ],
        ),
      );
    ...
    return Row(
      ...
      children: <Widget>[
        IconButton(
          ...
          color: postOrientation == "grid" ? Colors.white //Theme.of(context).primaryColor
              : Colors.grey,
        ),
        IconButton(
          onPressed: () => setOrientation("list"),
          icon: Icon(Icons.list),
          color: postOrientation == "list" ? Colors.white //Theme.of(context).primaryColor
              : Colors.grey,
        ),
      ],
    );
