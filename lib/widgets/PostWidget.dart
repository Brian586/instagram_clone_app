  ...
  createPostPicture() {
    return GestureDetector(
      ...
      child: Stack(
        ...
        children: <Widget>[
          Image.network(url),
          showHeart ? Icon(Icons.favorite, color: Colors.pink, size: 80.0,) : Text(""),
        ],
      ),
    );
  }
      ...
      children: <Widget>[
        Row(
          ...
          children: <Widget>[
            ...
            GestureDetector(
              ...
              child: Icon(Icons.chat_bubble_outline, size: 25.0, color: Colors.white,),
            ),
          ],
        ),
        Row(
        ...
        Row(
          ...
          children: <Widget>[
            Container(
              margin: EdgeInsets.only(left: 20.0),
              child: Text("$username  ", style: TextStyle(color: Colors.blue, fontWeight: FontWeight.bold),),
            ),
            Expanded(
